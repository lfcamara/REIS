					...
					<div class='col-lg-12 text-center'>
						<h2 class="negrito">
							<img class='img-responsive' width="100px" height="100px"
								src='../images/reis_logo.png' style="margin: auto;" /> Cadastre-se!
						</h2>
					</div>
					...
					<form:form id="formCadastro" modelAttribute="loginDomain" method="post">
						...
						<div class="mdl-cell mdl-cell--12-col">
							...
							<div class="form-group">
								...
								<form:errors path="login" cssClass="h4-small reis-verde-NUTES"/><br />
							</div>					
						</div>
						...
						<div class="mdl-cell mdl-cell--12-col">
							...
							<div class="form-group">
								<form:input path="paciente.nome" type="text" class="form-control" placeholder="Nome" />
							</div>
						</div>
						
						<div class="mdl-cell mdl-cell--12-col">
							<label class="demo-panel-title">Sobrenome</label>
							<div class="form-group">
								<form:input path="paciente.sobrenome" type="text"
						...
						<div class="mdl-cell mdl-cell--12-col">
							<label class="demo-panel-title">Data de Nascimento</label>
							<div class="form-group">
								<form:input id="data" path="paciente.dataNascimento" type="text" maxlength="10"
						...
						<div class="mdl-cell mdl-cell--12-col">
							<label class="demo-panel-title">Estado</label>
							<div class="form-group">
								<form:input path="paciente.estado" type="text"
									class="form-control" placeholder="Cidade" />
							</div>
						</div>
